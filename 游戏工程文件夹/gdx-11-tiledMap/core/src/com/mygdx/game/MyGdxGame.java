         ...
         //可破坏障碍的树的碰撞检测
            ...
            */
               ...
               if(layer instanceof TiledMapTileLayer){
                   ...
                   mapCells.put("树木", tileLayer.getCell(3, 0));
                   mapCells.put("土地", tileLayer.getCell(4, 0));
                   mapCells.put("树1-1", tileLayer.getCell(5, 0));
                   mapCells.put("树2-1", tileLayer.getCell(6, 0));
                   mapCells.put("树3-1", tileLayer.getCell(7, 0));
                   mapCells.put("树1-2", tileLayer.getCell(5, 1));
                   mapCells.put("树2-2", tileLayer.getCell(6, 1));
                   mapCells.put("树3-2", tileLayer.getCell(7, 1));
                   mapCells.put("树1-3", tileLayer.getCell(5, 2));
                   mapCells.put("树2-3", tileLayer.getCell(6, 2));
                   mapCells.put("树3-3", tileLayer.getCell(7, 2));
                   mapCells.put("树1-4", tileLayer.getCell(5, 3));
                   mapCells.put("树2-4", tileLayer.getCell(6, 3));
                   mapCells.put("树3-4", tileLayer.getCell(7, 3));
               }
           }
